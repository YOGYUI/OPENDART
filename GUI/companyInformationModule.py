...
class CompanyInformationWidget(QWidget):
    ...
    def initLayout(self):
        ...
        vbox.addWidget(self._tableInfo)
    ...
    def initControl(self):
        ...
        self._tableInfo.setRowCount(len(row_names))
        self._tableInfo.setVerticalHeaderLabels(row_names)
        self._tableInfo.setColumnCount(1)
        self._tableInfo.horizontalHeader().hide()
        self._tableInfo.horizontalHeader().setSectionResizeMode(QHeaderView.Stretch)
        stylesheet = "QTableWidget::item {padding: 10px;}"
        self._tableInfo.setStyleSheet(stylesheet)
        for r in range(self._tableInfo.rowCount()):
            item = ReadOnlyTableItem()
            self._tableInfo.setItem(r, 0, item)
    ...
    def drawTable(self):
        ...
        try:
            ...
            item = self._tableInfo.item(row, 0)

...
from PyQt5.QtWidgets import QWidget, QTreeWidget, QTreeWidgetItem, QComboBox, QSpinBox, QRadioButton
...
class BusinessReportWidget(QWidget):
...
class BusinessReportSubWindow(QMdiSubWindow):
    ...
    def __init__(self, dart_obj: OpenDart = None, parent=None):
        ...
        self.setWindowTitle('Business Report Detail')

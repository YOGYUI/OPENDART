...
class DailyDocumentWidget(QWidget):
    ...
    def __init__(self, dart_obj: OpenDart = None, parent=None):
        ...
        self._radioSortTime = QRadioButton('시간')
        self._radioSortCorpName = QRadioButton('회사명')
        self._radioSortDocName = QRadioButton('문서 제목')
        self._radioSortAscending = QRadioButton('오름차순')
        self._radioSortDescending = QRadioButton('내림차순')
